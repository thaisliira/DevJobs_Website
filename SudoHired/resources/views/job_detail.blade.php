...
<div class="container py-5">
    ...
    <div class="stat-card p-5 mb-4">
        ...
        <div class="d-flex flex-wrap gap-2 mb-4">
            ...
            <!-- uppercase first, transforma apenas a 1 letra em maiuscula -->
    ...
    <div class="stat-card p-4 mb-4">
        ...
        <ul class="list-unstyled d-flex flex-column">
            <!-- parte o texto onde houver um ponto final na BD -->
                ...
                <div class="d-flex flex-column gap-4 h-100">
                    ...
                    <div class="text-muted d-flex align-items-start" style="min-height: 80px;">
                        ...
                        <div>
                            ...
                            <small>Não pagamos horas extras: usa o teu banco de horas quando nós permitirmos e agradece.</small>
                        </div>
                    </div>
                </div>
            </div>
